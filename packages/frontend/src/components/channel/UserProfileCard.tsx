  ...
  return (
    <>
      ...
      <div className="fixed z-50 w-72 rounded-lg bg-white shadow-2xl border" style={{ top: position.top, left: position.left }}>
        <div className="bg-indigo-600 h-16 rounded-t-lg" />
        <div className="px-4 pb-4 -mt-8">
          ...
          <div className="mt-3 flex gap-2">
            <button className="flex-1 rounded bg-indigo-600 px-3 py-1.5 text-sm text-white hover:bg-indigo-700">Nachricht</button>
          </div>
        </div>
      </div>
    </>
